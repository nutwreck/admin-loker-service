...
func (h *handleKategoriPekerjaan) HandlerResults(ctx *gin.Context) {
	res, error := h.kategoriPekerjaan.EntityResults()

	if error.Type == "error_results_01" {
		helpers.APIResponse(ctx, "Kategori Pekerjaan data not found", error.Code, nil)
		return
	}
...
/**
* ================================================
* Handler Result Kategori Pekerjaan By ID Teritory
*=================================================
 */
// GetByIDKategoriPekerjaan godoc
// @Summary		Get By ID Kategori Pekerjaan
// @Description	Get By ID Kategori Pekerjaan
// @Tags		Kategori Pekerjaan
// @Accept		json
// @Produce		json
// @Param		id path string true "Get By ID Kategori Pekerjaan"
// @Success 200 {object} schemes.SchemeResponses
// @Failure 400 {object} schemes.SchemeResponses400Example
// @Failure 401 {object} schemes.SchemeResponses401Example
// @Failure 403 {object} schemes.SchemeResponses403Example
...
// @Failure 500 {object} schemes.SchemeResponses500Example
// @Security	ApiKeyAuth
// @Router /api/v1/kategori-pekerjaan/result/{id} [get]
